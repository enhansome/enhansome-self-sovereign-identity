...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 56 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-31 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 533 | 🐛 86 | 🌐 Rust | 📅 2026-08-31 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 642 | 🐛 73 | 🌐 Java | 📅 2026-08-31 - Universal DID resolver implementation and method specific drivers.
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 490 | 🐛 157 | 🌐 Python | 📅 2026-08-31 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 351 | 🐛 302 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript framework for building decentralized identity and verifiable credential solutions.
...
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 304 | 🐛 55 | 🌐 Kotlin | 📅 2026-08-31 - All-in-one open-source identity and wallet toolkit.
* [DID Resolver](https://github.com/decentralized-identity/did-resolver) ⭐ 231 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-31 - A simple common interface for JavaScript applications to resolve DID documents from Decentralized Identifiers (DIDs).
  * [ethr DID Resolver](https://github.com/decentralized-identity/ethr-did-resolver) ⭐ 238 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Use Ethereum addresses as fully self managed Decentralized Identifiers and wrap them in a DID Document.
...
* [Bifold Wallet](https://github.com/openwallet-foundation/bifold-wallet) ⭐ 204 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-28 - An open source Aries mobile agent build with React Native and Aries Framework JavaScript.
...
* [sd-jwt-js](https://github.com/openwallet-foundation/sd-jwt-js) ⭐ 81 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-29 - A TypeScript implementation of the SD-JWT & SD-JWT-VC specification from Open Wallet Foundation.
...
* [OpenID for Verifiable Credentials](https://github.com/openwallet-foundation-labs/oid4vc-ts) ⭐ 29 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript library implementation of OpenID4VC and OpenID4VCI protocols.
...
* [mDOC](https://github.com/animo/mdoc) ⭐ 13 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript library to work with ISO 18013-5 and ISO 18013-7 mDOC (and mDL).
...
* [Expo mDOC Data Transfer](https://github.com/animo/expo-mdoc-data-transfer) ⭐ 5 | 🐛 14 | 🌐 Kotlin | 📅 2026-05-25 - Expo Module for ISO 18013-5 Data Transfer.
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 490 | 🐛 157 | 🌐 Python | 📅 2026-08-31 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 351 | 🐛 302 | 🌐 TypeScript | 📅 2026-08-31 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 351 | 🐛 302 | 🌐 TypeScript | 📅 2026-08-31 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 490 | 🐛 157 | 🌐 Python | 📅 2026-08-31 - Quick course on how to get started with ACA-Py.
