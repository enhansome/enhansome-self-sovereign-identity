...
* [Web Of Trust Self-Sovereign Identity Repository](https://github.com/WebOfTrustInfo/self-sovereign-identity) ⭐ 153 | 🐛 5 | 📅 2022-12-07 - Articles and documents associated with designing and implementing identity technology using self-sovereign identity principles.
...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 56 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-07 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 533 | 🐛 89 | 🌐 Rust | 📅 2026-09-07 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 643 | 🐛 73 | 🌐 Java | 📅 2026-09-08 - Universal DID resolver implementation and method specific drivers.
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 491 | 🐛 153 | 🌐 Python | 📅 2026-09-07 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 351 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript framework for building decentralized identity and verifiable credential solutions.
* [IOTA Identity](https://github.com/iotaledger/identity.rs) ⭐ 346 | 🐛 119 | 🌐 Rust | 📅 2026-08-20 - Implementation of the decentralized identity standards such as DIDs and VCs by W3C for the IOTA Tangle.
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 308 | 🐛 61 | 🌐 Kotlin | 📅 2026-09-08 - All-in-one open-source identity and wallet toolkit.
* [DID Resolver](https://github.com/decentralized-identity/did-resolver) ⭐ 231 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - A simple common interface for JavaScript applications to resolve DID documents from Decentralized Identifiers (DIDs).
  * [ethr DID Resolver](https://github.com/decentralized-identity/ethr-did-resolver) ⭐ 239 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-08 - Use Ethereum addresses as fully self managed Decentralized Identifiers and wrap them in a DID Document.
  * [web DID Resolver](https://github.com/decentralized-identity/web-did-resolver) ⭐ 102 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-07 - Use domains accessed through https as Decentralized Identifiers and retrieve an associated DID Document.
...
* [Universal Registrar](https://github.com/decentralized-identity/universal-registrar) ⭐ 90 | 🐛 6 | 🌐 Java | 📅 2026-08-22 - Universal DID registrar implementation and method specific drivers.
...
* [sd-jwt-js](https://github.com/openwallet-foundation/sd-jwt-js) ⭐ 83 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-29 - A TypeScript implementation of the SD-JWT & SD-JWT-VC specification from Open Wallet Foundation.
...
* [DCQL](https://github.com/openwallet-foundation-labs/dcql-ts) ⭐ 29 | 🐛 9 | 🌐 TypeScript | 📅 2026-06-01 - TypeScript implementation of the Digital Credentials Query Language.
* [OpenID for Verifiable Credentials](https://github.com/openwallet-foundation-labs/oid4vc-ts) ⭐ 29 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-07 - TypeScript library implementation of OpenID4VC and OpenID4VCI protocols.
...
* [mDOC](https://github.com/animo/mdoc) ⭐ 13 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - TypeScript library to work with ISO 18013-5 and ISO 18013-7 mDOC (and mDL).
...
* [Expo mDOC Data Transfer](https://github.com/animo/expo-mdoc-data-transfer) ⭐ 5 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-08 - Expo Module for ISO 18013-5 Data Transfer.
* [Expo Digital Credentials API](https://github.com/animo/expo-digital-credentials-api) ⭐ 4 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Expo Module to automatically set up and configure Digital Credentials API for Android apps.
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 491 | 🐛 153 | 🌐 Python | 📅 2026-09-07 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 351 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-08 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 351 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-08 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 491 | 🐛 153 | 🌐 Python | 📅 2026-09-07 - Quick course on how to get started with ACA-Py.
* [Best-of-digital-identity](https://github.com/jruizaranguren/best-of-digital-identity) ⭐ 190 | 🐛 0 | 📅 2026-09-04 - Ranking, popularity and activity status of open-source digital identity projects, including decentralized identity projects.
