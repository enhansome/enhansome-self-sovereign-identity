...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 57 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-23 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 535 | 🐛 46 | 🌐 Rust | 📅 2026-09-24 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 644 | 🐛 75 | 🌐 Java | 📅 2026-09-24 - Universal DID resolver implementation and method specific drivers.
...
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 352 | 🐛 300 | 🌐 TypeScript | 📅 2026-09-24 - TypeScript framework for building decentralized identity and verifiable credential solutions.
...
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 311 | 🐛 23 | 🌐 Kotlin | 📅 2026-09-24 - All-in-one open-source identity and wallet toolkit.
* [DID Resolver](https://github.com/decentralized-identity/did-resolver) ⭐ 232 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-24 - A simple common interface for JavaScript applications to resolve DID documents from Decentralized Identifiers (DIDs).
  * [ethr DID Resolver](https://github.com/decentralized-identity/ethr-did-resolver) ⭐ 240 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-23 - Use Ethereum addresses as fully self managed Decentralized Identifiers and wrap them in a DID Document.
  * [web DID Resolver](https://github.com/decentralized-identity/web-did-resolver) ⭐ 102 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-24 - Use domains accessed through https as Decentralized Identifiers and retrieve an associated DID Document.
...
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 352 | 🐛 300 | 🌐 TypeScript | 📅 2026-09-24 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 352 | 🐛 300 | 🌐 TypeScript | 📅 2026-09-24 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
