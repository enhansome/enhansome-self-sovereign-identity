...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 56 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-07 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 534 | 🐛 80 | 🌐 Rust | 📅 2026-09-09 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 644 | 🐛 73 | 🌐 Java | 📅 2026-09-10 - Universal DID resolver implementation and method specific drivers.
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 492 | 🐛 153 | 🌐 Python | 📅 2026-09-09 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 352 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-09 - TypeScript framework for building decentralized identity and verifiable credential solutions.
...
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 309 | 🐛 64 | 🌐 Kotlin | 📅 2026-09-10 - All-in-one open-source identity and wallet toolkit.
* [DID Resolver](https://github.com/decentralized-identity/did-resolver) ⭐ 231 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - A simple common interface for JavaScript applications to resolve DID documents from Decentralized Identifiers (DIDs).
  * [ethr DID Resolver](https://github.com/decentralized-identity/ethr-did-resolver) ⭐ 239 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-10 - Use Ethereum addresses as fully self managed Decentralized Identifiers and wrap them in a DID Document.
  * [web DID Resolver](https://github.com/decentralized-identity/web-did-resolver) ⭐ 102 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Use domains accessed through https as Decentralized Identifiers and retrieve an associated DID Document.
...
* [mDOC](https://github.com/animo/mdoc) ⭐ 13 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-07 - TypeScript library to work with ISO 18013-5 and ISO 18013-7 mDOC (and mDL).
...
* [Expo mDOC Data Transfer](https://github.com/animo/expo-mdoc-data-transfer) ⭐ 5 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-10 - Expo Module for ISO 18013-5 Data Transfer.
* [Expo Digital Credentials API](https://github.com/animo/expo-digital-credentials-api) ⭐ 4 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - Expo Module to automatically set up and configure Digital Credentials API for Android apps.
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 492 | 🐛 153 | 🌐 Python | 📅 2026-09-09 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 352 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-09 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 352 | 🐛 303 | 🌐 TypeScript | 📅 2026-09-09 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 492 | 🐛 153 | 🌐 Python | 📅 2026-09-09 - Quick course on how to get started with ACA-Py.
