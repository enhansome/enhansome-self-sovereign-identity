...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 534 | 🐛 86 | 🌐 Rust | 📅 2026-09-09 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 643 | 🐛 73 | 🌐 Java | 📅 2026-09-09 - Universal DID resolver implementation and method specific drivers.
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 491 | 🐛 152 | 🌐 Python | 📅 2026-09-08 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 352 | 🐛 304 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript framework for building decentralized identity and verifiable credential solutions.
...
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 309 | 🐛 64 | 🌐 Kotlin | 📅 2026-09-09 - All-in-one open-source identity and wallet toolkit.
...
* [OpenID for Verifiable Credentials](https://github.com/openwallet-foundation-labs/oid4vc-ts) ⭐ 29 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript library implementation of OpenID4VC and OpenID4VCI protocols.
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 491 | 🐛 152 | 🌐 Python | 📅 2026-09-08 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 352 | 🐛 304 | 🌐 TypeScript | 📅 2026-09-08 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 352 | 🐛 304 | 🌐 TypeScript | 📅 2026-09-08 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 491 | 🐛 152 | 🌐 Python | 📅 2026-09-08 - Quick course on how to get started with ACA-Py.
...
* [Hyperledger Aries RFCs](https://github.com/decentralized-identity/aries-rfcs/blob/main/index.md) ⭐ 344 | 🐛 59 | 🌐 Python | 📅 2026-08-11 - Specifications of Aries protocols and standards.
