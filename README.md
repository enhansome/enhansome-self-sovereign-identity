...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 533 | 🐛 69 | 🌐 Rust | 📅 2026-08-19 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 488 | 🐛 160 | 🌐 Python | 📅 2026-08-17 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 349 | 🐛 300 | 🌐 TypeScript | 📅 2026-08-18 - TypeScript framework for building decentralized identity and verifiable credential solutions.
* [IOTA Identity](https://github.com/iotaledger/identity.rs) ⭐ 347 | 🐛 117 | 🌐 Rust | 📅 2026-08-12 - Implementation of the decentralized identity standards such as DIDs and VCs by W3C for the IOTA Tangle.
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 301 | 🐛 56 | 🌐 Kotlin | 📅 2026-08-18 - All-in-one open-source identity and wallet toolkit.
...
* [OpenID for Verifiable Credentials](https://github.com/openwallet-foundation-labs/oid4vc-ts) ⭐ 29 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-18 - TypeScript library implementation of OpenID4VC and OpenID4VCI protocols.
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 488 | 🐛 160 | 🌐 Python | 📅 2026-08-17 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 349 | 🐛 300 | 🌐 TypeScript | 📅 2026-08-18 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 349 | 🐛 300 | 🌐 TypeScript | 📅 2026-08-18 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 488 | 🐛 160 | 🌐 Python | 📅 2026-08-17 - Quick course on how to get started with ACA-Py.
