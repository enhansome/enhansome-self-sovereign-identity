...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 56 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-17 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 533 | 🐛 47 | 🌐 Rust | 📅 2026-08-18 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 644 | 🐛 74 | 🌐 Java | 📅 2026-08-18 - Universal DID resolver implementation and method specific drivers.
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 488 | 🐛 159 | 🌐 Python | 📅 2026-08-17 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 349 | 🐛 297 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript framework for building decentralized identity and verifiable credential solutions.
* [IOTA Identity](https://github.com/iotaledger/identity.rs) ⭐ 347 | 🐛 116 | 🌐 Rust | 📅 2026-08-12 - Implementation of the decentralized identity standards such as DIDs and VCs by W3C for the IOTA Tangle.
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 301 | 🐛 56 | 🌐 Kotlin | 📅 2026-08-17 - All-in-one open-source identity and wallet toolkit.
...
* [Bifold Wallet](https://github.com/openwallet-foundation/bifold-wallet) ⭐ 203 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-17 - An open source Aries mobile agent build with React Native and Aries Framework JavaScript.
...
* [Universal Registrar](https://github.com/decentralized-identity/universal-registrar) ⭐ 88 | 🐛 7 | 🌐 Java | 📅 2026-08-11 - Universal DID registrar implementation and method specific drivers.
* [sd-jwt-js](https://github.com/openwallet-foundation/sd-jwt-js) ⭐ 81 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-17 - A TypeScript implementation of the SD-JWT & SD-JWT-VC specification from Open Wallet Foundation.
...
* [OpenID for Verifiable Credentials](https://github.com/openwallet-foundation-labs/oid4vc-ts) ⭐ 29 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript library implementation of OpenID4VC and OpenID4VCI protocols.
...
* [mDOC](https://github.com/animo/mdoc) ⭐ 13 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript library to work with ISO 18013-5 and ISO 18013-7 mDOC (and mDL).
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 488 | 🐛 159 | 🌐 Python | 📅 2026-08-17 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 349 | 🐛 297 | 🌐 TypeScript | 📅 2026-08-17 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 349 | 🐛 297 | 🌐 TypeScript | 📅 2026-08-17 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 488 | 🐛 159 | 🌐 Python | 📅 2026-08-17 - Quick course on how to get started with ACA-Py.
