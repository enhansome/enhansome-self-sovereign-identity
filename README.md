...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 532 | 🐛 44 | 🌐 Rust | 📅 2026-08-14 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [Universal Resolver](https://github.com/decentralized-identity/universal-resolver) ⭐ 643 | 🐛 74 | 🌐 Java | 📅 2026-08-15 - Universal DID resolver implementation and method specific drivers.
...
* [DID Resolver](https://github.com/decentralized-identity/did-resolver) ⭐ 232 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - A simple common interface for JavaScript applications to resolve DID documents from Decentralized Identifiers (DIDs).
  * [ethr DID Resolver](https://github.com/decentralized-identity/ethr-did-resolver) ⭐ 237 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-14 - Use Ethereum addresses as fully self managed Decentralized Identifiers and wrap them in a DID Document.
