...
* [Paradym Wallet](https://github.com/animo/paradym-wallet) ⭐ 56 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-24 - Mobile wallet to seamlessly manage and present your digital credentials.
...
* [VC on Internet Identity](https://github.com/dfinity/internet-identity/blob/main/docs/vc-spec.md) ⭐ 532 | 🐛 79 | 🌐 Rust | 📅 2026-08-24 - A wallet-less and privacy preserving VC protocol built on top Internet Identity on ICP.
...
* [ACA-Py](https://github.com/openwallet-foundation/acapy) ⭐ 490 | 🐛 158 | 🌐 Python | 📅 2026-08-24 - Foundation for building decentralized identity applications and services running in non-mobile environments.
* [Credo](https://github.com/openwallet-foundation/credo-ts) ⭐ 350 | 🐛 301 | 🌐 TypeScript | 📅 2026-08-24 - TypeScript framework for building decentralized identity and verifiable credential solutions.
...
* [walt.id Identity Lib](https://github.com/walt-id/waltid-identity) ⭐ 303 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-24 - All-in-one open-source identity and wallet toolkit.
...
* [mDOC](https://github.com/animo/mdoc) ⭐ 13 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-24 - TypeScript library to work with ISO 18013-5 and ISO 18013-7 mDOC (and mDL).
...
* [ACA-Py Demo](https://github.com/openwallet-foundation/acapy/tree/main/demo) ⭐ 490 | 🐛 158 | 🌐 Python | 📅 2026-08-24 - There are several demos available for ACA-Py mostly (but not only) aimed at developers learning how to deploy an instance of the agent and an ACA-Py controller to implement an application.
* [Credo Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo) ⭐ 350 | 🐛 301 | 🌐 TypeScript | 📅 2026-08-24 - Walk through the Credo flow yourself together with agents Alice and Faber in this demo.
* [Credo OpenID Demo](https://github.com/openwallet-foundation/credo-ts/tree/main/demo-openid) ⭐ 350 | 🐛 301 | 🌐 TypeScript | 📅 2026-08-24 - Walk through the Credo OpenID flow yourself together with agents Alice and Faber in this demo.
...
* [Become a ACA-Py Developer](https://github.com/openwallet-foundation/acapy/tree/main/docs/gettingStarted) ⭐ 490 | 🐛 158 | 🌐 Python | 📅 2026-08-24 - Quick course on how to get started with ACA-Py.
